...
exports.hash = async function (options) {
    ...
    switch (options.method || 'argon2i') {
        case 'argon2d':
            return await argon2.hash(options.password, { type: argon2.argon2d, ...argon2Options }) 
        case 'argon2i':
            return await argon2.hash(options.password, { type: argon2.argon2i, ...argon2Options })     
        case 'argon2id':
            return await argon2.hash(options.password, { type: argon2.argon2id, ...argon2Options }) 
      } 
  };
